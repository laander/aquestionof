...
function enable_farbtastic_color_picker() {
	...
	wp_register_script('farbtastic', (THEME_URI . '/library/js/farbtastic/farbtastic.js')); 
	wp_enqueue_script('farbtastic');
	
	wp_register_style('farbtastic', (THEME_URI . '/library/js/farbtastic/farbtastic.css'));
