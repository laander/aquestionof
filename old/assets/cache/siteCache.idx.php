<?php
$c=&$this->config;
$c['manager_theme'] = "MODxLaander";
$c['settings_version'] = "1.0.2";
$c['server_offset_time'] = "0";
$c['server_protocol'] = "http";
$c['manager_language'] = "english";
$c['modx_charset'] = "UTF-8";
$c['site_name'] = "A QUESTION OF";
$c['site_start'] = "2";
$c['error_page'] = "2";
$c['unauthorized_page'] = "2";
$c['site_status'] = "1";
$c['site_unavailable_message'] = "The A QUESTION OF site is currently unavailable. Please try again later.";
$c['track_visitors'] = "0";
...
$c['emailsender'] = "thomas@aquestionof.dk";
...
$c['use_editor'] = "1";
$c['use_browser'] = "1";
$c['rb_base_dir'] = "/mounted-storage/home78a/sub001/sc44123-UTTZ/aquestionof.dk/assets/";
$c['rb_base_url'] = "assets/";
$c['which_editor'] = "TinyMCE";
$c['fe_editor_lang'] = "danish";
...
$c['show_preview'] = "1";
$c['filemanager_path'] = "/mounted-storage/home78a/sub001/sc44123-UTTZ/aquestionof.dk/assets/";
$c['theme_refresher'] = "";
$c['manager_layout'] = "4";
...
$m = &$this->documentMap;
$d['aquestionof'] = 2;
$a[2] = array('id' => 2, 'alias' => 'aquestionof', 'path' => '');
$m[] = array('0' => '2');
$d['about'] = 3;
$a[3] = array('id' => 3, 'alias' => 'about', 'path' => '');
$m[] = array('0' => '3');
$d['organic'] = 4;
$a[4] = array('id' => 4, 'alias' => 'organic', 'path' => '');
$m[] = array('0' => '4');
$d['organic-cotton'] = 5;
$a[5] = array('id' => 5, 'alias' => 'organic-cotton', 'path' => '');
$m[] = array('0' => '5');
$d['made-in-africa'] = 6;
$a[6] = array('id' => 6, 'alias' => 'made-in-africa', 'path' => '');
$m[] = array('0' => '6');
$d['social'] = 9;
$a[9] = array('id' => 9, 'alias' => 'social', 'path' => '');
$m[] = array('0' => '9');
$d['blog'] = 25;
$a[25] = array('id' => 25, 'alias' => 'blog', 'path' => '');
$m[] = array('0' => '25');
$d['retail'] = 8;
$a[8] = array('id' => 8, 'alias' => 'retail', 'path' => '');
$m[] = array('0' => '8');
$d['contact'] = 19;
$a[19] = array('id' => 19, 'alias' => 'contact', 'path' => '');
$m[] = array('0' => '19');
$d['shop'] = 21;
$a[21] = array('id' => 21, 'alias' => 'shop', 'path' => '');
$m[] = array('0' => '21');
$d['newsletters'] = 12;
$a[12] = array('id' => 12, 'alias' => 'newsletters', 'path' => '');
$m[] = array('0' => '12');
$d['subscribe-newsletter'] = 14;
$a[14] = array('id' => 14, 'alias' => 'subscribe-newsletter', 'path' => '');
$m[] = array('0' => '14');
$d['newsletter-fall-2008'] = 20;
$a[20] = array('id' => 20, 'alias' => 'newsletter-fall-2008', 'path' => '');
$m[] = array('12' => '20');
$d['NEWSLETTER-WINTER-2009'] = 15;
$a[15] = array('id' => 15, 'alias' => 'NEWSLETTER-WINTER-2009', 'path' => '');
$m[] = array('12' => '15');
$c = &$this->contentTypes;
$c = &$this->chunkCache;
$c['WebLoginSideBar'] = '
...
';
$c['Topmenu-Outer'] = '<ul id="topmenu-outer">[+wf.wrapper+]</ul>';
$c['Topmenu-RowTpl'] = '<li class="topmenu-rowtpl [+wf.classnames+]"><a href="[+wf.link+]" title="[+wf.title+]" [+wf.attributes+]>[+wf.linktext+]</a></li>';
$c['Topmenu-HereTpl'] = '<li class="topmenu-heretpl"><a href="[+wf.link+]" title="[+wf.title+]" [+wf.attributes+]>[+wf.linktext+]</a></li>';
$c['Footer'] = '<div>
<div class="footer-newsletter" style="float:right;"><a href="[~14~]" title="Sign up for the newsletter">Sign up for our newsletter</a></div>
<div style="float:left;"><a href="http://www.facebook.com/#/pages/A-QUESTION-OF/72860482534?ref=ts" title="Join our Facebook Group" >Facebook</a></div>
<div style="float:left;margin-left: 5px;"> / </div>
<div style="float:left;margin-left: 5px;"><a href="http://twitter.com/A_QUESTION_OF" title="Follow us on Twitter" >Twitter</a></div>
<div style="clear: both;"></div>
</div>';
$c['MM-Rules'] = '// PHP *is* allowed
...
$s['TXNewsletters'] = '/*--------------------------------------------------------------------------------------------------------
 Snippet Name:        TXNewsletters
 Short Description:   <strong>0.9</strong> - TXNewsletters subscribe / unsubscribe form snippet
 Version:  0.9
 Authors:  Franck TRUILLOT
           Manuel STEPHAN
 Usage:
   Display subscribe form : [!TXNewsletters? &action=add!]
   Display unsubscribe form on another page if necessary : [!TXNewsletters!]
   Add a &lang=... parameter to display forms with a specific language with value : english, francais, francais-utf8, ... 
--------------------------------------------------------------------------------------------------------*/
//Options :
$modx->TXNewsletters[\'lang\'] = isset($modx->config[\'manager_language\']) ? $modx->config[\'manager_language\'] : \'english\';  
$modx->TXNewsletters[\'lang\'] = isset($lang) ? $lang : $modx->TXNewsletters[\'lang\'];
$modx->TXNewsletters[\'emailFrom\']=$emailFrom;
$modx->TXNewsletters[\'newslettersBaseId\']=$newslettersBaseId;
$modx->TXNewsletters[\'nbPerPage\']=$nbPerPage;
$modx->TXNewsletters[\'idPageSubscribe\']=$idPageSubscribe;
$modx->TXNewsletters[\'idPageUnsubscribe\']=$idPageUnsubscribe;
//includes
$modx->TXNewsletters[\'tb_prefix\'] = $modx->db->config[\'table_prefix\'];
$modx_root_dir =$modx->config[\'base_path\'];
$modx_base_url = $modx->config[\'base_url\'];
$modx->TXNewsletters[\'path\'] = $modx->config[\'base_path\'] . "assets/modules/txnewsletters/";
$modx->TXNewsletters[\'path_url\'] = $modx->config[\'base_url\'] . "assets/modules/txnewsletters/";
include_once($modx->TXNewsletters[\'path\'].\'txnewsletters.version.inc.php\');
if(file_exists($modx->TXNewsletters[\'path\'].\'lang/lang.\'.$modx->TXNewsletters[\'lang\'].\'.inc.php\')){
	include_once($modx->TXNewsletters[\'path\'].\'lang/lang.\'.$modx->TXNewsletters[\'lang\'].\'.inc.php\');
}
else {
	include_once($modx->TXNewsletters[\'path\'].\'lang/lang.english.inc.php\');
}
include_once($modx->TXNewsletters[\'path\'].\'txnewsletters.inc.php\');
include_once($modx->TXNewsletters[\'path\'].\'csv.class.inc.php\');
if(file_exists($modx->TXNewsletters[\'path\'].\'conf/conf.\'.$modx->TXNewsletters[\'lang\'].\'.xml\')){
	$fichier = $modx->TXNewsletters[\'path\'].\'conf/conf.\'.$modx->TXNewsletters[\'lang\'].\'.xml\';
}
else {
	$fichier = $modx->TXNewsletters[\'path\'].\'conf/conf.english.xml\';
}
$fichier_import = $modx->TXNewsletters[\'path\'].\'txnewsletters.datas.csv\';
$modx->TXNewsletters[\'fields\'] = getFields($fichier);
//////////////////////////////////////////////////////////////
if(!isset($action)){$action=\'\';}
$action = isset($_POST[\'formmenuaction\']) ? delCode($_POST[\'formmenuaction\']) : $action;
$action = isset($_GET[\'action\']) ? delCode($_GET[\'action\']) : $action;
switch ($action) {
/* Affichage formulaire d\'inscription */
case \'add\' :
  $Err = NULL;
  echo formHTML(\'add_send\',$Err);
break;
/* Affichage formulaire d\'inscription après envoi / inscription Ok */
case \'add_send\' :
  $Err = checkForm();
  $nbErr = count($Err);
  $testEmail = testEmail();
  if ($nbErr>0 || $testEmail==true) {
    if($testEmail){ echo $modx->TXNewsletters[\'txtlang\'][\'email_err\'].\'<br /><br />\'."\\n"; }
    echo formHTML(\'add_send\',$Err);
  }
  else {
    $xmlPost = checkPost();
    $sql = genSQLinsert($xmlPost);
    $results = $modx->db->query($sql);
    if($results) { echo $modx->TXNewsletters[\'txtlang\'][\'subscribe_ok\'].\'<br />\'."\\n"; }
    else{
      echo $modx->TXNewsletters[\'txtlang\'][\'subscribe_err1\'].\'<br />\'."\\n";
      echo $modx->TXNewsletters[\'txtlang\'][\'subscribe_err2\'].\'<br />\'."\\n";
    }
  }
break;
/* Affichage formulaire de changement d\'inscription / annulation inscription */
case \'del\' :
  if (isset($_GET[\'email\']) && strlen($_GET[\'email\'])>6 && isset($_GET[\'control\'])){
    $email = delCode($_GET[\'email\']);
    $MD5 = delCode($_GET[\'control\']);
    if(checkControl($email,$MD5) && testEmail($email)){
      echo \'<div>\'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_msg\'].\'</div>\'."<br />\\n";
      $sql = genSQLedit($email);
      $results = $modx->db->query($sql);
      $values = mysql_fetch_assoc($results);
      echo formHTMLeditMod($email,\'del_edit\',$values);
    }
  }
break;
/* Affichage désinscription */
case \'del_send\' :
  if (isset($_POST[\'lastEmail\']) && strlen($_POST[\'lastEmail\'])<6){
    echo \'>> \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_notok1\'].\'<br /><br />\';
    echo $modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_notok2\'].\'<br />\';
    echo \'<a href="/"> \'.$modx->TXNewsletters[\'txtlang\'][\'msg_back_to_home\'].\' </a> \';
  }
  elseif(isset($_POST[\'lastEmail\'])) {
    $sql = genSQLdel(delCode($_POST[\'lastEmail\']));
    $results = $modx->db->query($sql);
  if ($results){
    echo \'>> \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_ok1\'].\' " \'.$_POST[\'lastEmail\'].\' " \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_ok2\']."<br /><br />\\n";
    echo \'<a href="/"> \'.$modx->TXNewsletters[\'txtlang\'][\'msg_back_to_home\'].\' </a> \';
  }
  else {
    echo \'>> \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_notok1\'].\'<br /><br />\';
...
break;
/* Affichage modification inscription */
case \'del_edit\' :
  $Err = checkForm();
  if ($Err[\'Subscribe\']) {
    if($testEmail){ echo $modx->TXNewsletters[\'txtlang\'][\'email_err\'].\'<br /><br />\'."\\n"; }
    echo formHTMLMod(\'del_edit\',$Err);
  }
  else {
    $xmlPost = checkPost($fields);
    $sql = genSQLupdateMod($xmlPost);
    @$results = $modx->db->query($sql);
    if($results) { echo \'>> \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_edit_ok\'].\'<br /><br />\'."\\n"; }
    else { echo \'>> \'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_edit_notok1\'].\'<br />\'.$modx->TXNewsletters[\'txtlang\'][\'subscribe_mod_edit_notok2\'].\'<br />\'."\\n"; }
  }
break;
/* Par defaut */
default :
...
//////////////////////////////////////////////////////////////';
$s['TXNewslettersProps'] = ' &emailFrom=Sending Email;text;info@aqo.dk &newslettersBaseId=Newsletters directory (id);text;12 &nbPerPage=Item per page;text;15 &idPageSubscribe=Page Subscribe;text;14 &idPageUnsubscribe=Page Unsubscribe;text;14';
$p = &$this->pluginCache;
$p['Search Highlight'] = '
/*
  ------------------------------------------------------------------------
...
include($asset_path);
';
$p['ManagerManagerProps'] = '&config_chunk=Configuration Chunk;text;MM-Rules &remove_deprecated_tv_types_pref=Remove deprecated TV types;list;yes,no;yes &which_jquery=jQuery source;list;local (assets/js),remote (google code),manual url (specify below);local (assets/js) &js_src_type=jQuery URL override;text; ';
$p['TransAlias'] = '
/*
...
$p['Quick Manager+Props'] = '&jqpath=Path to jQuery;text;assets/js/jquery-1.3.2.min.js &loadmanagerjq=Load jQuery in manager;list;true,false;true &loadfrontendjq=Load jQuery in front-end;list;true,false;true &noconflictjq=jQuery noConflict mode in front-end;list;true,false;true &loadtb=Load modal box in front-end;list;true,false;true &tbwidth=Modal box window width;text;90% &tbheight=Modal box window height;text;90% &hidefields=Hide document fields from front-end editors;text;parent &hidetabs=Hide document tabs from front-end editors;text; &hidesections=Hide document sections from front-end editors;text; &addbutton=Show add document here button;list;true,false;true &tpltype=New document template type;list;parent,id,selected;parent &tplid=New document template id;int;3  &custombutton=Custom buttons;textarea; &managerbutton=Show go to manager button;list;true,false;true &logout=Logout to;list;manager,front-end;manager &disabled=Plugin disabled on documents;text; ';
$e = &$this->pluginEvent;
